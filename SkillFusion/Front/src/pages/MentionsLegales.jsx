  ...
  return (
    <>
      ...
      <main className="max-w-4xl mx-auto my-8 p-4">
        <h2 className="font-display text-center text-2xl md:text-4xl mb-8">Mentions légales</h2>
        <section className="mb-6 p-4 bg-skill-tertiary/30 rounded-lg border border-skill-success/30">
          <h3 className="font-display text-xl md:text-2xl mb-2">Éditeur du site</h3>
          <p className="text-justify px-4 max-w-[95vw] text-skill-text-primary">
            ...
            Contact&nbsp;: <a href="mailto:skillfusion@gmail.com" className="text-skill-secondary hover:text-skill-accent no-underline">skillfusion@gmail.com</a>
          </p>
        </section>
        <section className="mb-6 p-4 bg-skill-tertiary/30 rounded-lg border border-skill-success/30">
          <h3 className="font-display text-xl md:text-2xl mb-2">Hébergement</h3>
          <p className="text-justify px-4 max-w-[95vw] text-skill-text-primary">
            ...
            Site web&nbsp;: <a href="https://vercel.com" className="text-skill-secondary hover:text-skill-accent no-underline">https://vercel.com</a>
          </p>
          <p className="text-justify px-4 max-w-[95vw] text-skill-text-primary">
            Pour le back-end&nbsp;:<br />
            <em>Render</em><br />
            ...
            Téléphone&nbsp;: Non communiqué<br />
            Site web&nbsp;: <a href="https://render.com" className="text-skill-secondary hover:text-skill-accent no-underline">https://render.com</a>
          </p>
        </section>
        <section className="mb-6 p-4 bg-skill-tertiary/30 rounded-lg border border-skill-success/30">
          <h3 className="font-display text-xl md:text-2xl mb-2">Propriété intellectuelle</h3>
          <p className="text-justify px-4 max-w-[95vw] text-skill-text-primary">
        ...
        <section className="mb-6 p-4 bg-skill-tertiary/30 rounded-lg border border-skill-success/30">
          <h3 className="font-display text-xl md:text-2xl mb-2">Données personnelles</h3>
          <p className="text-justify px-4 max-w-[95vw] text-skill-text-primary">
            ...
            Pour exercer ce droit, contactez-nous à l'adresse&nbsp;: <a href="mailto:skillfusion@gmail.com" className="text-skill-secondary hover:text-skill-accent no-underline">skillfusion@gmail.com</a>
          </p>
        </section>
        <section className="mb-6 p-4 bg-skill-tertiary/30 rounded-lg border border-skill-success/30">
          <h3 className="font-display text-xl md:text-2xl mb-2">Cookies</h3>
          <p className="text-justify px-4 max-w-[95vw] text-skill-text-primary">
        ...
        <section className="mb-6 p-4 bg-skill-tertiary/30 rounded-lg border border-skill-success/30">
          <h3 className="font-display text-xl md:text-2xl mb-2">Limitation de responsabilité</h3>
          <p className="text-justify px-4 max-w-[95vw] text-skill-text-primary">
