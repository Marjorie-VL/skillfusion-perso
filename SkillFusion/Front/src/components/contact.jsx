  ...
  return (
    <>
      ...
      <main className="flex flex-col justify-center items-center min-h-[calc(100vh-200px)] mb-8">
        <h2 className="font-display text-center text-2xl md:text-4xl my-8">Nous contacter</h2>
        ...
        <div className="w-full flex justify-center mb-8">
          <div className="m-8">
            <h3 className="font-display text-xl md:text-2xl mb-4">Nos coordonnées :</h3>
            <p className="my-4">Téléphone : 06.05.99.24.64</p>
            <p className="my-4">Mail : <a href="mailto:skillfusion@gmail.com" className="text-skill-secondary hover:text-skill-accent no-underline">skillfusion@gmail.com</a></p>
